                                                        ...
                                                        <div className="flex items-center gap-4">
                                                            <div className="w-14 h-14 rounded-xl overflow-hidden bg-gray-100 flex-shrink-0 border border-gray-100 relative">
                                                                {listing.urlAnhChinh && listing.urlAnhChinh !== 'FILE_SELECTED' ? (
                                                                    <BackendImage src={listing.urlAnhChinh} fill className="object-cover" alt={listing.tieuDe || ''} sizes="56px" />
                                                                ) : listing.hinhAnhs && listing.hinhAnhs.length > 0 ? (
                                                                    <BackendImage src={listing.hinhAnhs[0].urlHinhAnh} fill className="object-cover" alt={listing.tieuDe || ''} sizes="56px" />
                                                                ) : (
                                    ...
                                    <div className="p-4 space-y-4">
                                        <div className="flex gap-4">
                                            <div className="w-20 h-20 rounded-xl overflow-hidden bg-gray-100 flex-shrink-0 relative">
                                                {listing.urlAnhChinh && listing.urlAnhChinh !== 'FILE_SELECTED' ? (
                                                    <BackendImage src={listing.urlAnhChinh} fill className="object-cover" alt={listing.tieuDe || ''} sizes="80px" />
                                                ) : listing.hinhAnhs && listing.hinhAnhs.length > 0 ? (
                                                    <BackendImage src={listing.hinhAnhs[0].urlHinhAnh} fill className="object-cover" alt={listing.tieuDe || ''} sizes="80px" />
                                                ) : (
                                                    <div className="w-full h-full flex items-center justify-center text-gray-300 bg-gray-100">
